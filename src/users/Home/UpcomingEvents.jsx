            ...
            {events.map((item)=> (
                <div key={item.id} className='bg-blue-800 lg:flex p-2 rounded-xl'>
                  <div className='p-2 rounded-xl flex lg:flex-col flex-row gap-2 justify-center text-center' style={{background:"skyblue"}}>
                     <p className='lg:text-5xl text-2xl font-bold text-white'>{item.event_day}</p>
                  ...
                  <div className='text-center w-full grid gap-2 py-2 place-items-center'>
                    <div className=''>
                      <h2 className='text-2xl font-bold text-white'>Upcoming Events</h2><hr className='text-white mt-2 w-full'/>
                    </div>
                    <p className='text-xl font-bold text-white'>{item.event_note}</p>
                  </div>
                </div>
            ))}
        </section><br />

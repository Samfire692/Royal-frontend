    ...
    <div className=''>
      <section id='role' className='h-screen py-3'>
        ...
        <div className='cards flex flex-col md:flex-row gap-5 lg:gap-0 md:gap-1 place-items-center h-[80vh] justify-evenly px-3'>
            {/* Admin */}
           <Link to={"/admin/dashboard"} className='hover:rotate-3 hover:transition-all focus:rotate-3 focus:transition-all'>
             <div className='border-4 border-slate-100 py-3 px-2 lg:w-[25vw] md:w-[32vw] text-center rounded-4xl'>
             <FaUser className='text-9xl mx-auto mb-3 text-blue-800'/><hr />
           ...
           <Link className='hover:rotate-3 hover:transition-all focus:rotate-3 focus:transition-all'>
             ...
             <FaChalkboardTeacher className='text-9xl mx-auto mb-3 text-blue-800'/><hr />
             <h3 className='text-2xl font-bold mt-2 text-blue-900'>Teacher/Staff</h3>
           ...
           <Link className='hover:rotate-3 hover:transition-all focus:rotate-3 focus:transition-all' to={'/student/'}>
             ...
             <FaUserGraduate className='text-9xl mx-auto mb-3 text-blue-800'/><hr />

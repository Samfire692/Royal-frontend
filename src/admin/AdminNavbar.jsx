...
export const AdminNavbar = () => {
 ...
 navigate('/admin/')
  ...
  const fetchData = async()=> {
    const adminId = localStorage.getItem("AdminProfile");
    setAdminid(adminId);
  ...
  return (
   <div className='lg:px-3 lg:pt-5'>
      ...
      <div className='flex flex-col gap-4 w-full'>
        ...
        <button className='flex items-center gap-3 w-full px-3 py-2 mt-20 text-red-100 hover:bg-red-600 rounded-lg transition-all' onClick={handleLogout}>

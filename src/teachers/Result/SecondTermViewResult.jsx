...
export const SecondTermViewResult = ({ targetYear }) => {
    ...
    const [isLocked, setIsLocked] = useState(false); // Safety structural block state
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (activeSessionData && activeSessionData.length > 0) {
                ...
                // 🛑 ACCESS CONTROL LOCK: If it's still First Term globally, lock Second Term views completely!
            ...
            if (teacher?.assigned_class) {
                ...
                // Fetch scores matching Second Term records
        ...
        return (
            <div className="flex flex-col items-center justify-center p-12 text-center border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50 text-slate-400">
                ...
                <p className="text-sm max-w-md">
                    You cannot inspect or modify Second Term summary details while the academic portal configuration is actively running inside the First Term cycle.
                </p>
            </div>
        );
    }
                                ...
                                <div className="p-6 border-t border-slate-100 bg-slate-50/40 space-y-5">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-white p-3 rounded-xl border border-slate-200 text-center shadow-sm">
                                            <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Aggregated Score (2nd Term)</p>
